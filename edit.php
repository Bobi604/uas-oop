...
// Cek jika ada parameter nim
if (isset($_GET['nim'])) {
    $nim = $_GET['nim'];
    $data = $mhs->show();
    $mahasiswa = array_filter($data, function ($item) use ($nim) {
        return $item['nim'] === $nim;
    });
        ...
        <div class="card p-4 mx-auto" style="width: 28rem;">
            ...
            <form action="" method="post">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="laki" name="gender" value="L" <?php echo (isset($mahasiswa['gender']) && $mahasiswa['gender'] === 'L') ? 'checked' : ''; ?>>
                    <label class="form-check-label" for="laki">Laki-Laki</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="perempuan" name="gender" value="P" <?php echo (isset($mahasiswa['gender']) && $mahasiswa['gender'] === 'P') ? 'checked' : ''; ?>>
